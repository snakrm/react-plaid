...
export default function Section2() {
  return (
    <div>
      <h1 className="text-5xl mb-3 lg:mb-10 font-semibold ml-10 lg:ml-24 mt-24 tracking-wide">Plaid powers the apps in<br/>
       your financial life</h1>
    <div className="lg:flex justify-center  mt-20">
      <div className="lg:flex items-center lg:pl-10 lg:pt-45 ">
        ...
        <div className="lg:pl-10 pl-20">
          <h3 className="text-4xl mb-3 font-semibold">Personal finances</h3>
          <div className="pt-8">
            <p>
      ...
      <div className="lg:flex items-center lg:pl-10  lg:pt-45 mt-10 lg:mt-0">
        ...
        <div className=" ml-20 lg:ml-10">
          <h3 className="text-4xl mb-3 font-semibold">Business finances</h3>
          <div className="pt-8">
            <p >
    ...
    <div className="lg:flex items-center lg:pl-20 lg:pt-28 lg:pb-32 pb-24 pt-10 ">
        ...
        <div className="lg:pl-10 pl-24 pt-0">
          <h3 className="text-4xl lg:mb-3 font-semibold">Consumer payments</h3>
          <div className="pt-8">
            <p>
